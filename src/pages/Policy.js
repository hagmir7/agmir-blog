    ...
    <div className="Policy">
      ...
      <div className='container bg-light p-3 policy'>
        ...
        <ul>
          ...
          <li>
            <p><strong>Website</strong> refers to FreeWsad, accessible from <a href="https://www.freewsad.com" rel="external nofollow noopener" target="_blank">https://www.freewsad.com</a></p>
          </li>
          <li>
        ...
        <ul>
          <li>By visiting this page on our website: <a href="https://www.freewsad.com/contact/" rel="external nofollow noopener" target="_blank">https://www.freewsad.com/contact/</a></li>
        </ul>
      </div>
      <Footer />
    </div>
